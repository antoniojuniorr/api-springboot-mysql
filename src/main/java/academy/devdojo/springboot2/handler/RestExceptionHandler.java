...
import academy.devdojo.springboot2.exception.BadRequestExcepetionDetails;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<BadRequestExcepetionDetails> handleBadRequestExcepetionDetails(BadRequestException bre) {
		return new ResponseEntity<>(
				BadRequestExcepetionDetails.builder().timestamp(LocalDateTime.now())
